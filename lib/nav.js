...
export const NAV_ITEMS = [
  ...
  { href: "/fbcontent", icon: "✍️", label: "Viết bài FB" },
  { href: "/rewrite", icon: "📝", label: "Sửa bài theo khung" },
  { href: "/customers", icon: "👥", label: "Khách hàng" },
  { href: "/news", icon: "📰", label: "Tin tức đồ Nhật" },
  { href: "/warehouse", icon: "📦", label: "Kho sản phẩm" },
];
