// lib/music.js — Nhạc nền thư giãn không lời, phát ở mọi trang.
// Dùng các bản nhạc hòa tấu CC0 (miễn phí bản quyền) lưu trên Internet Archive.
import { useEffect, useRef, useState } from "react";
import { useTheme } from "./theme";
import { playClick } from "./sound";

export const TRACKS = [
  { title: "Landra's Dream", src: "https://archive.org/download/peaceful-tracks/009.mp3" },
  { title: "Isolation Waltz", src: "https://archive.org/download/peaceful-tracks/010.mp3" },
  { title: "Horizon Flare", src: "https://archive.org/download/peaceful-tracks/033.mp3" },
  { title: "Champ de tournesol", src: "https://archive.org/download/peaceful-tracks/016.mp3" },
  { title: "La Citadelle", src: "https://archive.org/download/peaceful-tracks/044.mp3" },
];
    ...
    <div style={{ position: "fixed", right: 18, bottom: 18, zIndex: 50 }}>
      ...
      {open && (
        ...
        >
          ...
          <div style={{ fontSize: 14, fontWeight: 600, color: THEME.text, marginBottom: 10, minHeight: 20 }}>
