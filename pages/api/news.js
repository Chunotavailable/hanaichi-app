// pages/api/news.js
// Lưu/đọc danh sách tin tức đồ Nhật bằng Vercel Blob — cùng cơ chế các API khác.
import { put, head } from "@vercel/blob";

const DATA_PATHNAME = "news/data.json";
...
async function readData() {
  try {
    ...
    return { ...DEFAULT_DATA, ...data, newsItems: Array.isArray(data.newsItems) ? data.newsItems : [] };
  } catch (e) {
    return DEFAULT_DATA;
  }
}
