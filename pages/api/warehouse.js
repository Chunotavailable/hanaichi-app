...
// Lưu/đọc danh sách sản phẩm tự thêm ở "Kho sản phẩm" bằng Vercel Blob.
import { put, head } from "@vercel/blob";

const DATA_PATHNAME = "warehouse/data.json";
const DEFAULT_DATA = { products: [] };
...
async function readData() {
  try {
    ...
    return { ...DEFAULT_DATA, ...data, products: Array.isArray(data.products) ? data.products : [] };
  } catch (e) {
    return DEFAULT_DATA;
  }
}
